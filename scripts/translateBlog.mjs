...
const projectId = 'elsoul-holdings'
const location = 'global'
const translationClient = new TranslationServiceClient({ projectId })

const froms = ['posts/blog/ja/**/*.md']
const targets = ['posts/blog/en/**/*.md']
...
async function translateBlog() {
  ...
  for await (const originalContent of originalContents) {
    try {
      ...
      const category = await googleTranslate(originalContent.category)
